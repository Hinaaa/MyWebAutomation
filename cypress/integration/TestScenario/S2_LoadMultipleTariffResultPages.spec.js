...
prodSelection.enterPersonalDetailsinPrivathaftpflicht(data.myAge, data.situationGroupText,data.totalTrafficCount) 
prodSelection.enterandComparePrivateInformation(data.birthDate, data.zipCode)

//pagination count
prodSelection.validatePagination(data.totalTrafficCount)
...
assertionObj.validateTotalTraficCount(data.totalTrafficCount)
}
